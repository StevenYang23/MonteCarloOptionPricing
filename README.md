...
Compare four different volatility modeling approaches side-by-side. The framework allows you to evaluate Constant Volatility GBM, Dupire Local Volatility, Heston Stochastic Volatility, and GARCH(1,1) models simultaneously.

<img src="demo_img/Simulated_Asset_Price.png" alt="Simulated Asset Price Paths" width="800" height="600">

### Monte Carlo Path Simulation

High-performance path simulation generating 100,000+ Monte Carlo paths for statistical accuracy. Visualize how different volatility models produce distinct price path behaviors.

<img src="demo_img/MC_path.png" alt="Monte Carlo Paths" width="800" height="600">

### Volatility Path Analysis

Track the evolution of volatility over time for each model. Compare constant volatility (GBM) with stochastic volatility processes (Heston, GARCH) and local volatility (Dupire).

<img src="demo_img/MC_vol_path.png" alt="Volatility Paths" width="800" height="600">

### Volatility Surface Construction

Build implied and local volatility surfaces from market data. The framework constructs market-implied volatility surfaces and converts them to local volatility using Dupire's formula.
...
Automatic option chain data retrieval using `yfinance`. The system automatically fetches real-time option data, computes implied volatilities, and prepares data for model calibration.

### Exotic Option Pricing

Price Shark Fin barrier options with American-style barrier monitoring. The framework supports path-dependent exotic options with knock-out features.

<img src="demo_img/Shark_Fin.png" alt="Shark Fin Payoff" width="800" height="500">

### Greeks Calculation

Compute Delta, Gamma, and Vega using Monte Carlo finite differences. Visualize how option sensitivities vary across spot prices and maturities.

<img src="demo_img/Greeks.png" alt="Option Greeks" width="800" height="600">

### Statistical Analysis

Perform confidence intervals and distribution analysis. Compare model outputs statistically to assess valuation differences and uncertainty quantification.
